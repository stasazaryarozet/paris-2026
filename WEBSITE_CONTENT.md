...
Ландшафт вокруг виллы — часть проекта. Аалто проектирует не здание, а жизнь: как свет входит в дом, как деревья создают тень, как пространство дышит. Здесь нет границы между интерьером и садом — архитектура плавно переходит в природу. Окна вырезают фрагменты парка как живые картины. Каждая дорожка, каждая скамья — продолжение философии заботы.
